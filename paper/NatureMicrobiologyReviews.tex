...
{\color{black}
We are disappointed that the reviewer does not view the work of sufficient impact and novelty for \textit{Nature Microbiology}, but we are appreciative of the statement that the study is ``performed to an extremely high technical standard.''
Personally, we feel that direct quantitative comparison of the escape from narrow and broad antibodies is valuable, since other comparisons have been more anecdotal.
In any case, we are now re-submitting to \textit{Nature Communications}, which places less emphasis on impact.
We also note that at least two of the four reviewers found the work to be of high impact---and even Reviewer \#3 praises it on a technical level.
